...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction_0_29_36(__pyx_t_1, "__pyx_fuse_0_copy", (void (**)(void))&__pyx_fuse_0__pyx_f_7sklearn_5utils_12_cython_blas__copy, "void (int, float const *, int, float const *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_0_29_36(__pyx_t_1, "__pyx_fuse_1_copy", (void (**)(void))&__pyx_fuse_1__pyx_f_7sklearn_5utils_12_cython_blas__copy, "void (int, double const *, int, double const *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_0_29_36(__pyx_t_1, "__pyx_fuse_0_rotg", (void (**)(void))&__pyx_fuse_0__pyx_f_7sklearn_5utils_12_cython_blas__rotg, "void (float *, float *, float *, float *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_0_29_36(__pyx_t_1, "__pyx_fuse_1_rotg", (void (**)(void))&__pyx_fuse_1__pyx_f_7sklearn_5utils_12_cython_blas__rotg, "void (double *, double *, double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_0_29_36(__pyx_t_1, "__pyx_fuse_0_rot", (void (**)(void))&__pyx_fuse_0__pyx_f_7sklearn_5utils_12_cython_blas__rot, "void (int, float *, int, float *, int, float, float)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_0_29_36(__pyx_t_1, "__pyx_fuse_1_rot", (void (**)(void))&__pyx_fuse_1__pyx_f_7sklearn_5utils_12_cython_blas__rot, "void (int, double *, int, double *, int, double, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
