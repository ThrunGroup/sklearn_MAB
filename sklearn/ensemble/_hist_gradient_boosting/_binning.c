...
static void __pyx_f_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_col_to_bins(__Pyx_memviewslice, __Pyx_memviewslice, unsigned char const , unsigned char const , int, __Pyx_memviewslice); /*proto*/
...
static PyObject *__pyx_pf_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_to_bins(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, PyObject *__pyx_v_binning_thresholds, __Pyx_memviewslice __pyx_v_is_categorical, unsigned char __pyx_v_missing_values_bin_idx, int __pyx_v_n_threads, __Pyx_memviewslice __pyx_v_binned); /* proto */
...
static PyObject *__pyx_pw_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning_1_map_to_bins(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_map_to_bins (wrapper)", 0);
  {
    ...
    __pyx_v_binned = __Pyx_PyObject_to_MemoryviewSlice_dcd__nn___pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_BINNED_DTYPE_C(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_binned.memview)) __PYX_ERR(0, 14, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_to_bins(__pyx_self, __pyx_v_data, __pyx_v_binning_thresholds, __pyx_v_is_categorical, __pyx_v_missing_values_bin_idx, __pyx_v_n_threads, __pyx_v_binned);
 ...
 */
    ...
    /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":44
 *             missing_values_bin_idx,
 *             n_threads,
 *             binned[:, feature_idx]             # <<<<<<<<<<<<<<
 *         )
...
__pyx_f_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_col_to_bins(__pyx_t_4, __pyx_t_5, (*((unsigned char const  *) ( /* dim=0 */ ((char *) (((unsigned char const  *) __pyx_v_is_categorical.data) + __pyx_t_6)) ))), __pyx_v_missing_values_bin_idx, __pyx_v_n_threads, __pyx_t_7);
 ...
 */
                            __pyx_t_5 = __pyx_v_i;
                            __pyx_t_6 = (isnan((*((__pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_DTYPE_C const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_5 * __pyx_v_data.strides[0]) )))) != 0);
                            if (!__pyx_t_6) {
                            } else {
                              __pyx_t_4 = __pyx_t_6;
 ...
 */
                            ...
                            __pyx_t_5 = __pyx_v_i;
                            __pyx_t_6 = (((*((__pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_DTYPE_C const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_5 * __pyx_v_data.strides[0]) ))) < 0.0) != 0);
                            __pyx_t_4 = __pyx_t_6;
 ...
 */
                              __pyx_t_5 = __pyx_v_i;
                              *((__pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_BINNED_DTYPE_C *) ( /* dim=0 */ (__pyx_v_binned.data + __pyx_t_5 * __pyx_v_binned.strides[0]) )) = __pyx_v_missing_values_bin_idx;
 ...
 */
                            /*else*/ {
                              ...
                              /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":75
 *             # for known values, use binary search
 *             left, right = 0, binning_thresholds.shape[0]
 *             while left < right:             # <<<<<<<<<<<<<<
 *                 # equal to (right + left - 1) // 2 but avoids overflow
 ...
 */
                              while (1) {
                                ...
                                /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":77
 *             while left < right:
 *                 # equal to (right + left - 1) // 2 but avoids overflow
 *                 middle = left + (right - left - 1) // 2             # <<<<<<<<<<<<<<
 ...
 */
                                ...
                                /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":78
 *                 # equal to (right + left - 1) // 2 but avoids overflow
 *                 middle = left + (right - left - 1) // 2
 *                 if data[i] <= binning_thresholds[middle]:             # <<<<<<<<<<<<<<
 *                     right = middle
 ...
 */
                                ...
                                __pyx_t_4 = (((*((__pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_DTYPE_C const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_5 * __pyx_v_data.strides[0]) ))) <= (*((__pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_DTYPE_C const  *) ( /* dim=0 */ (__pyx_v_binning_thresholds.data + __pyx_t_9 * __pyx_v_binning_thresholds.strides[0]) )))) != 0);
                                if (__pyx_t_4) {

                                  /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":79
 *                 middle = left + (right - left - 1) // 2
 *                 if data[i] <= binning_thresholds[middle]:
 *                     right = middle             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
                                ...
                                /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":81
 *                     right = middle
 *                 else:
 *                     left = middle + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
                              ...
                              /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":83
 *                     left = middle + 1
 * 
 *             binned[i] = left             # <<<<<<<<<<<<<<
 */
